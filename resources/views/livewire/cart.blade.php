                    ...
                    @forelse($products as $product)
                        <div class="col-md-3 mb-3" :key="{{$product->id}}">
                            ...
                            <div class="card">                 
                                ...
                                <button class="btn btn-primary btn-sm" wire:click="addItem({{$product->id}})" style="position:absolute;top:0;right:0;padding: 10px 15px"><i class="fas fa-cart-plus fa-lg"></i></button>
